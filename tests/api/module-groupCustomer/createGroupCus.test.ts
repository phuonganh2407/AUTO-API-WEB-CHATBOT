...
import {
  ...
  fullDataGroupCus,
  longNameGroupCus,
} from "../../../data/api/serviceCustomerData/groupCustomer.data";
import { createGroupCustomer } from "../../../services/api/customerApi/groupCustomer/groupCustomer.api"; // Update the path as needed
