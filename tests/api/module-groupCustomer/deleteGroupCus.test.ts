import { getIDGroupCusNoData } from "../../../data/api/serviceCustomerData/groupCustomer.data";
import { deleteGroupCustomer } from "../../../services/api/customerApi/groupCustomer/groupCustomer.api";
