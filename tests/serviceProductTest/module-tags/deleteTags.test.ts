...
describe("Xóa Thẻ tags cho Khách hàng, Nhà cung cấp, Sản phẩm, Đơn hàng", () => {
  test("@smoke TAG_DEL_006 - Xóa thành công thẻ tag chưa có dữ liệu liên kết", async () => {
  ...
  test("TAG_DEL_007 - Xóa thất bại thẻ tag có ID không tồn tại trong hệ thống", async () => {
