...
describe("Thêm mới Thẻ tags cho Khách hàng, Nhà cung cấp, Sản phẩm, Đơn hàng", () => {
  ...
  test("creTag_003 - Tạo thất bại thẻ tag với name đã tồn tại", async () => {
    ...
    test("creTag_004 - Tạo thất bại thẻ tag với name > 25 kí tự", async () => {
  ...
  test("creTag_005 - Tạo thất bại thẻ tag với name rỗng", async () => {
